...
The positional handler receives all remaining non-option tokens in a single
invocation.
...
- [`tests/src/kcli/tests/CoreCliTests.java`](../tests/src/kcli/tests/CoreCliTests.java)
- [`tests/src/kcli/tests/OmegaCliTests.java`](../tests/src/kcli/tests/OmegaCliTests.java)

The demo programs under [`demo/`](../demo/) show complete, working usage.
