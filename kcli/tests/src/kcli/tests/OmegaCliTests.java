...
final class OmegaCliTests {
    ...
    private static void testBetaWorkersInvalidOption() throws Exception {
        TestSupport.ProcessResult result = TestSupport.runJava("kcli.demo.omega.Main", "--beta-workers", "abc");
    ...
    private static void testNewGammaHelpRoot() throws Exception {
        TestSupport.ProcessResult result = TestSupport.runJava("kcli.demo.omega.Main", "--newgamma");
    ...
    private static void testKnownAndUnknownOption() throws Exception {
        TestSupport.ProcessResult result = TestSupport.runJava("kcli.demo.omega.Main", "--alpha-message", "hello", "--bogus");
    ...
    private static void testAlphaAliasOption() throws Exception {
        TestSupport.ProcessResult result = TestSupport.runJava("kcli.demo.omega.Main", "-a");
    ...
    private static void testBuildAliasOption() throws Exception {
        TestSupport.ProcessResult result = TestSupport.runJava("kcli.demo.omega.Main", "-b", "debug");
